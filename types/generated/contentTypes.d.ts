...
export interface ApiCandidaturaCandidatura extends Schema.CollectionType {
...
export interface ApiEventoEvento extends Schema.CollectionType {
  ...
  attributes: {
    NomeEvento: Attribute.String & Attribute.Required & Attribute.Unique;
    ...
    organizadorId: Attribute.Relation<
      ...
      'api::usuario.usuario'
    >;
    modalidade: Attribute.Relation<
      'api::evento.evento',
      'oneToOne',
      'api::modalidade.modalidade'
    >;
    jogadors: Attribute.Relation<
      'api::evento.evento',
      'oneToMany',
      'api::jogador.jogador'
    >;
...
export interface ApiJogadorJogador extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Idade: Attribute.Integer & Attribute.Required & Attribute.DefaultTo<0>;
    Posicao: Attribute.String & Attribute.Required;
...
export interface ApiModalidadeModalidade extends Schema.CollectionType {
...
export interface ApiPosicaoPosicao extends Schema.CollectionType {
  collectionName: 'posicaos';
  info: {
    singularName: 'posicao';
    pluralName: 'posicaos';
    displayName: 'Posicao';
  };
  options: {
  ...
  attributes: {
    Nome: Attribute.String & Attribute.Required;
    modalidade_id: Attribute.Relation<
      'api::posicao.posicao',
      'manyToOne',
      'api::modalidade.modalidade'
    >;
...
export interface ApiUsuarioUsuario extends Schema.CollectionType {
  ...
  attributes: {
    ...
    Senha: Attribute.Password & Attribute.Required;
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::jogador.jogador': ApiJogadorJogador;
      'api::modalidade.modalidade': ApiModalidadeModalidade;
      'api::posicao.posicao': ApiPosicaoPosicao;
